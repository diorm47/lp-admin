...
function Items() {
  const casesItems = [
    {
      id: 13232,
      name: "Кейс от Заечки 12 примогемов",
      category: "Кейс от блогеров",
      cost_rub: 100,
      cost_usd: 1,
      opens: 909,
  ...
  const cases = casesItems.slice(itemOffset, endOffset);
              ...
              <tbody>
                {cases.map((cases) => (
                  <tr>
                    ...
                    <td className="tac">{cases.cost_rub} ₽</td>
                    <td className="tac">{cases.cost_usd}$</td>
                    <td className="tac">{cases.opens}</td>
                    <td className="tac">
                      {cases.date.split(" ")[0]}
                      <br />
                      {cases.date.split(" ")[1]}
                    ...
                    <td>
                      <div className="cases_table_actions">
                        <div className="cases_table_actions_list">
                          ...
                          <div title="скопировать" className="cases_table_copy">
                            <svg
                              xmlns="http://www.w3.org/2000/svg"
                              width="24"
                              height="24"
