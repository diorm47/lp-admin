...
function CreateCase() {
  ...
  //   {
  //     "id": 1,
  //     "picture": "images/cases/asrdgtfhgjkhgjdfd.jpg",
  //     "created_at": "2023-10-11T19:30:27.786714",
  //     "case_id": "Xg5CbBqet",
  //     "name": "asrdgtfhgjkhgjdfd",
  //     "category_id": "Pr7GgYJ6S",
  //     "items": []
  // }
          ...
          <Tabs>
            ...
            <TabPanel>
              <div className="case_tab_content">
                ...
                <button className="main_btn case_save_btn" onClick={saveCase}>
                  Сохранить кейс
                </button>
              </div>
            </TabPanel>
